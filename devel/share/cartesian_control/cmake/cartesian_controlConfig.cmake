...
if("TRUE" STREQUAL "TRUE")
  set(cartesian_control_SOURCE_PREFIX /home/pi/catkin_ws/src/cartesian_control)
  set(cartesian_control_DEVEL_PREFIX /home/pi/catkin_ws/devel)
  ...
  set(cartesian_control_INSTALL_PREFIX /home/pi/catkin_ws/install)
...
if(NOT "/home/pi/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cartesian_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/cartesian_control/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT cartesian_control_NUM_DUMMY_TARGETS)
      set(cartesian_control_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::cartesian_control::wrapped-linker-option${cartesian_control_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR cartesian_control_NUM_DUMMY_TARGETS "${cartesian_control_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::cartesian_control::wrapped-linker-option${cartesian_control_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND cartesian_control_LIBRARIES "${interface_target_name}")
